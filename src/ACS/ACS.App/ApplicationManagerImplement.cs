...
namespace ACS.App
{
    public class ApplicationManagerImplement : AbstractManager, IApplicationManager
    {
        ...
        {
            return Configuration["Acs:Process:Name"];
        }

        public void CreateApplication(ACS.Core.Application.Model.Application application)
        {
            this.PersistentDao.Save(application);
        }

        public ACS.Core.Application.Model.Application GetApplication(string name)
        {
            return (ACS.Core.Application.Model.Application)this.PersistentDao.FindByName(typeof(ACS.Core.Application.Model.Application), name, false);
        }

        public System.Collections.IList GetApplicationsByType(string type)
        {
            return this.PersistentDao.FindByAttribute(typeof(ACS.Core.Application.Model.Application), "Type", type);
        }

        public System.Collections.IList GetApplicationNamesByType(string type)
        {
            return this.PersistentDao.FindPropertyByAttributesOrderBy(typeof(ACS.Core.Application.Model.Application), "Name", "Type", type, "Name");
        }
        ...
        public System.Collections.IList GetApplicationNamesByType(string type, string runningHardware)
        {
            ...
            System.Collections.IList applications = this.PersistentDao.FindByAttributes(typeof(ACS.Core.Application.Model.Application), attributes);
            System.Collections.ArrayList names = new System.Collections.ArrayList();
            foreach (ACS.Core.Application.Model.Application app in applications)
            {
                names.Add(app.Name);
            }
            return names;
        ...
        public System.Collections.IList GetApplicationNamesByState(string type, string state)
        {
            ...
            return this.PersistentDao.FindByAttributesOrderBy(typeof(ACS.Core.Application.Model.Application), attributes, "Name")
                .Cast<ACS.Core.Application.Model.Application>()
                .Select(app => app.Name)
                .ToList();
        }     
        ...
        {
            return this.PersistentDao.FindPropertyByAttributes(typeof(ACS.Core.Application.Model.Application), "Name", "InitialHardware", initialHardware);
        }
        ...
        public System.Collections.IList GetApplicationNamesByRunningHardware(string runningHardware, bool excludeControlServer)
        {
            ...
            {
                return this.PersistentDao.FindPropertyByAttributes(typeof(ACS.Core.Application.Model.Application), "Name", "RunningHardware", runningHardware);
            }

            return this.PersistentDao.FindByAttribute(typeof(ACS.Core.Application.Model.Application), "RunningHardware", runningHardware)
                .Cast<ACS.Core.Application.Model.Application>()
        ...
        {
            System.Collections.IList applications = this.PersistentDao.FindByAttribute(typeof(ACS.Core.Application.Model.Application), "RunningHardware", runningHardware);

            IEnumerable<ACS.Core.Application.Model.Application> filtered = applications.Cast<ACS.Core.Application.Model.Application>();
        ...
        public System.Collections.IList GetApplications(string type, string state)
        {
           Dictionary<string, object> attributes = new Dictionary<string, object>();
            ...
            return this.PersistentDao.FindByAttributes(typeof(ACS.Core.Application.Model.Application), attributes);
        }

        public System.Collections.IList GetApplicationsByState(string state)
        {
            return this.PersistentDao.FindByAttribute(typeof(ACS.Core.Application.Model.Application), "state", state);
        }

        public System.Collections.IList GetApplications()
        {
            return this.PersistentDao.FindAllOrderBy(typeof(ACS.Core.Application.Model.Application), "name");
        }

        public System.Collections.IList GetQueuedUiApplicationManagers()
        {
            return this.PersistentDao.FindByAttribute(typeof(ACS.Core.Application.Model.UiApplicationManager), "STATE", "REQUEST");
        }
        public int UpdateApplicationManagersState(string id, string state)
        {
            ...
            return this.PersistentDao.UpdateByAttributes(typeof(ACS.Core.Application.Model.UiApplicationManager), setAttributes, "ID", id);
        }
        ...
        public void DeleteApplication(ACS.Core.Application.Model.Application application)
        {
        ...
        {
            return this.PersistentDao.DeleteAll(typeof(ACS.Core.Application.Model.Application));
        }

        public void UpdateApplication(ACS.Core.Application.Model.Application application)
        {
        ...
        {
            return this.PersistentDao.UpdateByAttribute(typeof(ACS.Core.Application.Model.Application), setName, setValue, conditionName, conditionValue);
        }
        ...
        public int UpdateApplicationState(string name, string state)
        {
            ...
            return this.PersistentDao.UpdateByName(typeof(ACS.Core.Application.Model.Application), setAttributes, name);
        }
        ...
        {
            return this.PersistentDao.UpdateByName(typeof(ACS.Core.Application.Model.Application), "checkTime", date, name);
        }
        ...
        public virtual System.Collections.IList GetApplicationNamesByRunningHardware(string type, string state, string runningHardware)
        {
            Dictionary<string, object> attributes = new Dictionary<string, object>();
            attributes.Add("Type", type);
            attributes.Add("State", state);
