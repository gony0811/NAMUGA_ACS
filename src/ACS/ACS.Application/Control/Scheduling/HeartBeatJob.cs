...
namespace ACS.Control.Scheduling
{
    public class HeartBeatJob : AbstractJob
    {
        ...
        private bool CheckHeartBeat(IControlServerManager controlServerManager, ACS.Framework.Application.Model.Application application, XmlDocument document, long timeout)
        {
            bool result = false;
