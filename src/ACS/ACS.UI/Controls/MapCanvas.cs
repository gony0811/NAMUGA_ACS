...
public class MapCanvas : Control
{
    ...
    // Brushes
    private static readonly IBrush LinkAvailableBrush = new SolidColorBrush(Color.FromRgb(80, 180, 80));
    private static readonly IBrush LinkUnavailableBrush = new SolidColorBrush(Color.FromRgb(120, 120, 120));
    ...
    private static readonly IBrush NodeCommonBrush = new SolidColorBrush(Color.FromRgb(160, 160, 160));
    private static readonly IBrush NodeChargeBrush = new SolidColorBrush(Color.FromRgb(50, 200, 50));
    private static readonly IBrush NodeCrossBrush = new SolidColorBrush(Color.FromRgb(220, 200, 50));
    private static readonly IBrush NodeStockBrush = new SolidColorBrush(Color.FromRgb(70, 130, 220));
    private static readonly IBrush NodeMonitorBrush = new SolidColorBrush(Color.FromRgb(180, 100, 220));

    private static readonly IBrush VehicleIdleBrush = new SolidColorBrush(Color.FromRgb(30, 144, 255));
    private static readonly IBrush VehicleRunBrush = new SolidColorBrush(Color.FromRgb(50, 205, 50));
    private static readonly IBrush VehicleChargeBrush = new SolidColorBrush(Color.FromRgb(255, 215, 0));
    private static readonly IBrush VehicleDownBrush = new SolidColorBrush(Color.FromRgb(255, 60, 60));
    private static readonly IBrush VehicleDisconnectBrush = new SolidColorBrush(Color.FromRgb(128, 128, 128));

    private static readonly IPen VehicleOutlinePen = new Pen(Brushes.White, 2);
    ...
    public override void Render(DrawingContext context)
    {
        ...
        // Background
        context.DrawRectangle(new SolidColorBrush(Color.FromRgb(30, 30, 40)), null,
    ...
    private void DrawVehicles(DrawingContext context, IReadOnlyList<VehicleDto> vehicles, Dictionary<string, Point> nodePositions)
    {
        foreach (var vehicle in vehicles)
        {
            ...
            context.DrawRectangle(Brushes.DarkGray, null,
