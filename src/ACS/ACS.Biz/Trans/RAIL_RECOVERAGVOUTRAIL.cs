...
{
    class RAIL_RECOVERAGVOUTRAIL : BaseBizJob
    {
        ...
        {
            XmlDocument rail_recoveragvoutrail = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_recoveragvoutrail);
