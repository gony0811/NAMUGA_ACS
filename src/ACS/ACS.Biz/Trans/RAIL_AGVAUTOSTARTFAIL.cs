...
{
    class RAIL_AGVAUTOSTARTFAIL : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvautostartfail = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvautostartfail);
