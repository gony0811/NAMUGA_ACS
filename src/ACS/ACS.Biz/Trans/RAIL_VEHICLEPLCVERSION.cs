...
{
    class RAIL_VEHICLEPLCVERSION : BaseBizJob
    {
        ...
        {
            XmlDocument rail_vehicleplcversion = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_vehicleplcversion);
            if(ResourceService.CheckVehicle(vehicleMsg))
            {
                ...
                ResourceService.UpdateVehiclePlcVersion(vehicleMsg);
                return 0;
            }
            else
            {
