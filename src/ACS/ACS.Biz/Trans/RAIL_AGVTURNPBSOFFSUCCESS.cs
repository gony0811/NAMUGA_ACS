...
{
    class RAIL_AGVTURNPBSOFFSUCCESS : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvturnpbsoffsuccess = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvturnpbsoffsuccess);
