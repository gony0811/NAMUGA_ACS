...
{
    class RAIL_AGVAUTOSTARTSUCCESS : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvautostartsuccess = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvautostartsuccess);
