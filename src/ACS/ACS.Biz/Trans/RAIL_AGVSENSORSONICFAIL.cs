...
{
    class RAIL_AGVSENSORSONICFAIL : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvsensorsonicfail = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvsensorsonicfail);
