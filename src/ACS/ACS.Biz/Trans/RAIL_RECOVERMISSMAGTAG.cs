...
{
    class RAIL_RECOVERMISSMAGTAG : BaseBizJob
    {
        ...
        {
            XmlDocument rail_recovermissmagtag = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_recovermissmagtag);
