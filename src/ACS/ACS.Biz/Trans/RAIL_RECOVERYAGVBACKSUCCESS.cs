...
{
    class RAIL_RECOVERYAGVBACKSUCCESS : BaseBizJob
    {
        ...
        {
            XmlDocument rail_recoveryagvbacksuccess = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_recoveryagvbacksuccess);
