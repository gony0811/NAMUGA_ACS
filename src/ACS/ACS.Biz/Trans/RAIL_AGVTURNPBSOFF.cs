...
{
    class RAIL_AGVTURNPBSOFF : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvturnpbsoff = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvturnpbsoff);
