...
{
    class RAIL_AGVSENSORSONIC : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvsensorsonic = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvsensorsonic);
