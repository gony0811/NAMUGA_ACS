...
{
    class RAIL_RECOVERMISSMAGTAGSUCCESS : BaseBizJob
    {
        ...
        {
            XmlDocument rail_recovermissmagtagsuccess = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_recovermissmagtagsuccess);
