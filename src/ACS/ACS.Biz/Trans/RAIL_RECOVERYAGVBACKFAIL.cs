...
{
    class RAIL_RECOVERYAGVBACKFAIL : BaseBizJob
    {
        ...
        {
            XmlDocument rail_recoveryagvbackfail = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_recoveryagvbackfail);
