...
{
    class RAIL_AGVSENSORSONICSUCCESS : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvsensorsonicsuccess = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvsensorsonicsuccess);
