...
{
    class RAIL_RECOVERMISSMAGTAGFAIL: BaseBizJob
    {
        ...
        {
            XmlDocument rail_recovermissmagtagfail = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_recovermissmagtagfail);
