...
{
    class RAIL_AGVAUTOSTART : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvautostart = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvautostart);
