...
{
    class RAIL_AGVTURNPBSOFFFAIL : BaseBizJob
    {
        ...
        {
            XmlDocument rail_agvturnpbsofffail = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_agvturnpbsofffail);
