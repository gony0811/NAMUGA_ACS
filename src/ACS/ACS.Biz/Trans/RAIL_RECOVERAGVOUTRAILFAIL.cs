...
{
    class RAIL_RECOVERAGVOUTRAILFAIL : BaseBizJob
    {
        ...
        {
            XmlDocument rail_recoveragvoutrailfail = (XmlDocument)args[0];
            ...
            vehicleMsg = InterfaceService.CreateVehicleMessageFromES(rail_recoveragvoutrailfail);
