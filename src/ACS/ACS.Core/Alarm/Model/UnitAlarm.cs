...
namespace ACS.Core.Alarm.Model
{
    public class UnitAlarm : Entity
    {
        ...
        private DateTime? createTime = new DateTime(DateTime.Now.Millisecond);
        ...
        protected DateTime? CreateTime { get { return createTime; } set { createTime = value; } }
