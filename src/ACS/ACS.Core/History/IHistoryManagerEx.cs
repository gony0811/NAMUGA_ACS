...
namespace ACS.Core.History
{
    public interface IHistoryManagerEx
    {
        ...
        AlarmReportHistoryEx CreateAlarmReportHistory(ACS.Core.Alarm.Model.AlarmReport paramAlarmReport, String paramString);
        ...
        HeartBeatFailHistoryEx CreateHeartBeatFailHistory(ACS.Core.Application.Model.Application paramApplication);
        ...
        ApplicationHistoryEx CreateApplicationHistory(ACS.Core.Application.Model.Application paramApplication);
