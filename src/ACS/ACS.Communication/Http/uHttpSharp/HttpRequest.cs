...
using ACS.Communication.Http.uHttpSharp.Headers;namespace ACS.Communication.Http.uHttpSharp{
    ...
    internal class HttpRequest : IHttpRequest
    {
        ...
        private readonly string _reqUri;
        private readonly string[] _requestParameters;
        private readonly IHttpHeaders _queryString;
        private readonly IHttpPost _post;

        public HttpRequest(IHttpHeaders headers, HttpMethods method, string protocol, Uri uri, string reqUri, string[] requestParameters, IHttpHeaders queryString, IHttpPost post)
        {
            _headers = headers;
            _method = method;
            _protocol = protocol;
