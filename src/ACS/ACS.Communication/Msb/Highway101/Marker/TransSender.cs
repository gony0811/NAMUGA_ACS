...
{
    public class TransSender : GenericHighway101Sender
    {
        ...
        public void reply(XmlDocument secondary, XmlDocument primary, bool useCommunicationMessageNameForLogging, string communicationMessageName)
        {
            try
            {
                ...
                replyMessage.setData(secondary.OuterXml);
                logger.Info("message reply" + Environment.NewLine + XmlUtility.GetLogStringFromXml(secondary.DocumentElement));
