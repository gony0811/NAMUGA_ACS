...
{
    public class GenericHighway101Sender : AbstractHighway101, IMessageAgent, ISynchronousMessageAgent
    {
        ...
        public string Request(string message, string dest, long timeout, bool useCommunicationMessageNameForLogging, string communicationMessageName)
        {
            try
            {
                ...
                return MessageConverterUtils.GetMessageStringFormat(replyMessage);
            }
            catch (TrxException e)
            {
        ...
        public GenericHighway101Sender()
        {
            //Load Configuration

            //hostListener
            //this.Name               = "hostListener";
            //this.ConnectUrl         = "localhost:10101";                                //ConnectUrl
            //this.DefaultDestination = "/BN1/BNY3/ACS/FACTORY3/ACSmgr2";                 //Destination
            //this.SessionId          = "acsTS01server.MOS.LISTENER";                     //SessionId
            //this.CastOption         = "UNICAST";                                        //castOption
            //this.AutoRecoveryOption = true;                                             //AutoRecoveryOption
            //this.DeliveryMode       = "PULL";                                           //deliveryMode
            //this.DefaultTTL         = 10000;                                            //defaultTTL
            //this.PullTimeout        = 10000;                                            //PullTimeout
            //this.StationMode        = "INNER";                                          //StationMode
