...
{
    public class GenericTibrvSenderACS : AbstractTibrv, IMessageAgent, ISynchronousMessageAgent
    {
        ...
        public void Send(XmlDocument document, string dest, bool useCommunicationMessageNameForLogging, string communicationMessageName)
        {
            try
            {
                ...
                logger.Info("host message send" + System.Environment.NewLine + XmlUtility.GetLogStringFromXml(document.DocumentElement));
