...
{
    public class HostListener : GenericWorkflowTibrvCmListener
    {
        public override void onMsg(object tibrvListener, MessageReceivedEventArgs tibrvMsg)
        {
            try
            {
                ...
                if (obj is XmlDocument)
                {
                    ...
                    XmlElement header = document.DocumentElement["DataLayer"];
                    ...
                    string messageName = header["CmdType"] != null ? header["CmdType"].InnerText : "";
                    ...
                    {
                        onAwakeMessage(transactionId, messageName, document);
