...
{
    public class UiTransportDeleteMessageEx : AbstractMessage 
    {
        private static long serialVersionUID = 1L;
        public static string MESSAGE_NAME_UITRANSPORTDELETE = "UI-TRANSPORT-DELETE";
        ...
        //181001
        private string errorMsg = "UI_CANCEL";
