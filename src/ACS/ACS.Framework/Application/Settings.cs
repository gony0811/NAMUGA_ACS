...
namespace ACS.Framework.Application
{
    public class Settings
    {
        ...
        public static string SYSTEM_PROCESS_TYPE = "acs.process.type";
        public static string SYSTEM_PROCESS_MSB = "acs.process.msb";
        public static string SYSTEM_PROCESS_BASE = "acs.process.base";
        public static string SYSTEM_PROCESS_SERVICEPATH = "acs.process.servicepath";
